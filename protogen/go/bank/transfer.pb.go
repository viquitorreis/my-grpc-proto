...
type TransferRequest struct {
	...
	Currency          float64 `protobuf:"fixed64,3,opt,name=currency,proto3" json:"currency,omitempty"`
...
func (x *TransferRequest) GetCurrency() float64 {
	if x != nil {
		return x.Currency
	}
	return 0
...
func (x *TransferResponse) GetCurrency() float64 {
	if x != nil {
		return x.Currency
	}
	return 0
...
var file_proto_bank_type_transfer_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08,
	...
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63,
	0x79, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61,
